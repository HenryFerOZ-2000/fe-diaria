...
class AuthService {
  ...
  final GoogleSignIn _googleSignIn = GoogleSignIn(
    ...
    serverClientId:
        '475052295250-stk492qgav0cj1d5q1jdcfc1a6evsia7.apps.googleusercontent.com',
  );
  ...
  Future<GoogleSignInAccount?> signIn() async {
    try {
      ...
      if (e.code == '10' || e.code == 'DEVELOPER_ERROR') {
        errorMessage =
            'Error de configuración: Verifica que el SHA-1 esté registrado en Firebase Console.\n\n'
        ...
        errorMessage =
            'Error: La aplicación no está configurada correctamente en Google Cloud Console';
      } else if (e.code == '12501') {
        errorMessage = 'El usuario canceló el inicio de sesión';
      } else {
        errorMessage =
            'Error (código ${e.code}): ${e.message ?? "Error desconocido"}';
      }
